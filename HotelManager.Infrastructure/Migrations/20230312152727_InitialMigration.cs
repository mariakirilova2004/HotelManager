        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DismissionDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "A room with a single bed that is intended for one person to sleep in.", "Single Room" },
                    { 2, "A double room is a room intended for two people, usually a couple, to stay in. One person occupying a double room has to pay a supplement.", "Double Room" },
                    { 3, "A room or set of rooms fitted especially with housekeeping facilities.", "Apartment" },
                    { 4, "A flat on the top floor of a tall building, that is luxuriously fitted.", "Penthouse" },
                    { 5, "A maisonette has the living space split over two floors and is luxuriously fitted.", "Maisonette" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_RoomNumberId",
                table: "Reservations",
                column: "RoomNumberId");
